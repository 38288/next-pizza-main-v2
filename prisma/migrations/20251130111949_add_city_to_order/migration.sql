...
CREATE TABLE "TestIngredient" (
    ...
    CONSTRAINT "TestIngredient_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "TestProductItem" (
    "id" SERIAL NOT NULL,
    "price" INTEGER NOT NULL,
    "size" INTEGER,
    "pizzaType" INTEGER,
    "testProductId" INTEGER NOT NULL,

    CONSTRAINT "TestProductItem_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "_TestIngredientToTestProduct" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_TestIngredientToTestProduct_AB_unique" ON "_TestIngredientToTestProduct"("A", "B");

-- CreateIndex
CREATE INDEX "_TestIngredientToTestProduct_B_index" ON "_TestIngredientToTestProduct"("B");
...
-- AddForeignKey
ALTER TABLE "TestProductItem" ADD CONSTRAINT "TestProductItem_testProductId_fkey" FOREIGN KEY ("testProductId") REFERENCES "TestProduct"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TestProduct" ADD CONSTRAINT "TestProduct_testCategoryId_fkey" FOREIGN KEY ("testCategoryId") REFERENCES "TestCategory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_TestIngredientToTestProduct" ADD CONSTRAINT "_TestIngredientToTestProduct_A_fkey" FOREIGN KEY ("A") REFERENCES "TestIngredient"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_TestIngredientToTestProduct" ADD CONSTRAINT "_TestIngredientToTestProduct_B_fkey" FOREIGN KEY ("B") REFERENCES "TestProduct"("id") ON DELETE CASCADE ON UPDATE CASCADE;
